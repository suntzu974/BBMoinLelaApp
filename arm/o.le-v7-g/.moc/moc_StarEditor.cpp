...
const QMetaObjectExtraData StarEditor::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject StarEditor::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_StarEditor,
      qt_meta_data_StarEditor, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &StarEditor::getStaticMetaObject() { return staticMetaObject; }
